...
// Exhibit #0026: disposing a dependency you were only handed
...
// Request A: quote a price. The handler tidies up after itself.
...
{
    using var api = provider.GetRequiredService<PricingApi>(); // 💥 disposes what it borrowed
